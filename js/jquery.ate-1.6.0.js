    ...
    return {
        ...
        applycss: function(a) {
            if (!css2) {
                var b;
                b = '.addthisevent-drop {}';
                b += '.addthisevent-drop:hover {}';
                b += '.addthisevent-drop:active {top:1px;}';
                b += '.addthisevent-selected {}';
                b += '.addthisevent-drop .addthisevent_icon {}';
                if (a) {
                ...
                b += '.addthisevent_dropdown span {display:block;line-height:110%;background:#fff;text-decoration:none; color:#333;padding:8px 10px 9px 15px;}';
                b += '.addthisevent_dropdown span:hover {background:#f4f4f4;}';
