<div id="content" <?php Avada()->layout->add_style( 'content_style' ); ?>>
    ...
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div class="post-content">
            ...
            $args = array(
                ...
                'meta_query' => array(
                    array( 
                        'key' => 'dialogue_date',
                        'value' => $current_date,
                        'compare' => $meta_compare,	// posts before or equal to todays date depending on page
                        'type' => 'numeric' 
                    )
                ), 
            ...
            echo do_shortcode('[separator style_type="double" top_margin="20" bottom_margin="20" sep_color="#BBBBBB" border_size="" width="" alignment="" class="sep-1" id=""]'); 
			$dialogues_content .= '
