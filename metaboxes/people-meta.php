<div class="my_meta_control">
	...
	<p>
		...
		<span>Enter your full official staff title (used for current staff only)</span>
    </p>
	...
	<p>
		...
		<input type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
        <span><strong>without</strong> "http://" -- will display next to photo at top of bio page</span>
    </p> 
...
<div class="my_meta_control internal">
	...
	<label>Internal Use<span> used for sorting, will not appear on live site but must be filled out for each person</span></label>
	<p class="narrow">
