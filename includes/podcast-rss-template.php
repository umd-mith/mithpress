...
$args = array( 'post_type' => 'mith_podcast', 'posts_per_page' => 100 );
...
<rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" version="2.0">
  ...
  ?>
  <channel>
    <title><?php __('MITH Podcasts', 'Avada'); ?></title>
    <link><?php echo get_bloginfo('url'); ?></link>
    <language><?php echo get_bloginfo ( 'language' ); ?></language>
    <copyright><?php echo date('Y'); ?> <?php echo get_bloginfo('name'); ?></copyright>
    
    <itunes:author><?php __('Maryland Institute for Technology in the Humanities', 'Avada'); ?></itunes:author>
    ...
    <itunes:image href="http://dev.mith.org/podcast-image.png" />
