...
get_header(); ?>
    ...
    echo do_shortcode('[one_third spacing="yes" last="no" margin_top="20" margin_bottom="0"]&nbsp;[/one_third]');
	echo do_shortcode('[two_third spacing="yes" last="yes" id="mre_sorting" margin_top="20" margin_bottom="0"]' . $sort_by . '[/two_third]');
	echo do_shortcode('[one_third spacing="yes" last="no" id="mre_filters" class="filters-column gform_wrapper"]' . $filter_by . '[/one_third]');
	echo do_shortcode('[two_third last="yes" spacing="yes" class="" id="mre_items"]<div id="mre_loading"></div><!--RESEARCH ITEMS HERE-->[/two_third]');
	?>
	</div>
	<?php wp_reset_query(); ?>
