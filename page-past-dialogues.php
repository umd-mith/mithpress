    ...
    <div id="primary" class="width-limit">
		...
		<div id="content" role="main" class="span-16 wide last">
            ...
            <header class="page-header">
                <h1 class="page-title append-bottom prepend-top"><?php the_title(); ?></h1>
            </header><!-- /entry-header -->
			...
			$selected_tax = $newest_tax->slug;
		
			$args = array(
				'post_type' => 'podcast',
				'podcast_series' => $selected_tax,
			);
			
			$dialogues = new WP_Query( $args ); ?>
			
            <h2 class="podcasts-header"><span><?php echo $newest_tax->name; _e( ' Digital Dialogues', 'mithpress' ); ?></span>
		  ...
		  <?php if ( $dialogues->have_posts() ) : ?>
            <ul class="podcasts-list">

			  <?php while ( $dialogues->have_posts() ) : $dialogues->the_post(); ?>
              <?php 
